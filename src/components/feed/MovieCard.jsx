...
const ARTWORK_THEME = {
  ...
  logoFilter: () => "brightness(0) invert(1) drop-shadow(0 2px 6px rgba(0,0,0,0.8))",
...
const FILMSTRIP_THEME = {
  ...
  logoFilter: () => "brightness(0) invert(1) sepia(0.15) brightness(1.1) drop-shadow(0 1px 3px rgba(0,0,0,0.6))",
