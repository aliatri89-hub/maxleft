...
const STATUSES = [
  { key: "completed", label: "Beat", icon: "✓", color: t.green },
  { key: "playing", label: "Playing", icon: "▶", color: t.imdb },
      ...
      >
        ...
        <div
          style={{
            ...
            zIndex: 2,
            background:
              `linear-gradient(180deg, ${t.bgCard} 0%, rgba(26,23,20,0.95) 80%, transparent 100%)`,
            padding: "12px 0 16px",
            display: "flex",
        ...
        <div style={{ display: "flex", gap: 14, marginBottom: 14 }}>
          <div
            style={{
              ...
              borderRadius: 8,
              overflow: "hidden",
              background: `linear-gradient(135deg, ${t.bgCard}, ${t.bgPrimary})`,
              position: "relative",
            }}
          >
            {coverUrl ? (
              ...
              <div style={{ marginTop: 10 }}>
                ...
                >
                  <div style={{
                    ...
                    background: "rgba(249,104,54,0.15)",
                  ...
                  <div style={{ flex: 1, minWidth: 0, textAlign: "left" }}>
                    <div style={{
                      fontSize: 11, fontWeight: 700, color: t.metacritic,
                      fontFamily: t.fontDisplay,
              ...
              >
                ...
                <span
                  style={{
                    fontSize: 10,
                    fontWeight: 600,
                    color: platform === p.key ? t.imdb : t.textMuted,
                  }}
                >
                  {p.label}
                </span>
            ...
            {[1, 2, 3, 4, 5].map((n) => {
              ...
              return (
                <div
                  ...
                  style={{
                    color: isFull ? t.gold : isHalf ? t.gold : t.textFaint,
                  }}
                >
                  <div
        ...
        {episodeToast && matchedEpisode && isPatreonUrl(matchedEpisode.enclosureUrl) && (
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0, textAlign: "left" }}>
                <div style={{
                  fontSize: 14, fontWeight: 700, color: t.metacritic,
                  fontFamily: t.fontDisplay,
                  textTransform: "uppercase", letterSpacing: 0.5,
                }}>Listen on Patreon</div>
                <div style={{
