...
const GENRE_META = {
  ...
  action_spy:       { label: "Action / Spy",   icon: "💥", order: 3, tint: "#3d2a0f", poster: "https://image.tmdb.org/t/p/original/mMJtkhQcWpRLpbKgtkMYV5fCS6R.jpg", logoPos: "top", posterPos: "center 75%" },
  ...
  directors:        { label: "Directors",      icon: "🎬", order: 5, tint: "#2d2420", poster: "https://media.themoviedb.org/t/p/w440_and_h660_face/zWyVLIqgxipPfBDPQG9mgXIbyn1.jpg", logoPos: "bottom", posterPos: "center 25%" },
