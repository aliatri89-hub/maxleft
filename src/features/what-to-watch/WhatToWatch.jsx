    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 24px", position: "relative" }}>
      ...
      <div style={{ marginTop: 14, display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
        ...
        <button onClick={() => { haptic(); onSelect(film); }} style={{
          ...
          fontFamily: t.fontDisplay, fontWeight: 700, letterSpacing: 0.5,
        }}>This one →</button>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={onSelect} style={{
            ...
            fontFamily: t.fontDisplay, fontWeight: 700, flexShrink: 0,
          }}>Pick this</button>
        </div>
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      <div style={{ padding: "16px 20px 8px", textAlign: "center" }}>
        <div style={{ fontFamily: t.fontSerif, fontWeight: 700, fontSize: 18, color: AMBER }}>
  ...
  return (
    <div style={{ flex: 1, overflow: "auto", padding: "0 0 120px" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "24px 24px 16px" }}>
        ...
        <div style={{ fontFamily: t.fontHeadline, fontSize: 16, color: GREEN, marginTop: 16, letterSpacing: 2 }}>TONIGHT'S PICK</div>
      ...
      <div style={{ padding: "0 16px" }}>
        <div style={{ fontFamily: t.fontHeadline, fontSize: 16, color: AMBER, marginBottom: 12, paddingLeft: 4, letterSpacing: 2 }}>PODCAST COVERAGE</div>
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      <div style={{ flex: 1, overflow: "auto", padding: "16px 20px 120px" }}>
        ...
        {/* Podcasts */}
        <div style={{
          fontFamily: t.fontHeadline, fontSize: 16, letterSpacing: 2,
      ...
      <div style={{
        ...
        <button onClick={handleGo} disabled={!canGo} style={{
          ...
          fontFamily: t.fontDisplay, fontWeight: 700, letterSpacing: 1,
          opacity: canGo ? 1 : 0.4,
        }}>LET'S GO</button>
      </div>
    </div>
