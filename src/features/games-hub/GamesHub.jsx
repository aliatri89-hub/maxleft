...
const CSS = `
@import url('https://fonts.googleapis.com/css2?family=Permanent+Marker&family=Special+Elite&family=Bebas+Neue&display=swap');
...
export default function GamesHub({ session, onBack, onLaunchGame, gameStatuses = {} }) {
  ...
  function StatusPill({ gameId, color }) {
    ...
    if (status === "completed") {
      return (
        <span style={{
          fontFamily: "'Bebas Neue', sans-serif", fontSize: 13, letterSpacing: 1, padding: "3px 8px",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          fontFamily: "'Bebas Neue', sans-serif", fontSize: 16, letterSpacing: 1, color: "#c9a84c", whiteSpace: "nowrap",
        }}>
