...
export default function RewatchablesLogModal({
  ...
  const { matchedEpisode, isThisEpPlaying, playEpisode, isPlaying } = useEpisodeMatch(item, "The Rewatchables");
            ...
            {matchedEpisode && (
              <div
                ...
                style={{
                  ...
                  padding: "8px 12px", marginTop: 10, marginBottom: 4,
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{
                    fontSize: 11, fontWeight: 700, color: t.imdb,
                    textTransform: "uppercase", letterSpacing: "0.04em",
                  }}>{isThisEpPlaying && isPlaying ? "Now Playing" : "Listen on MANTL"}</div>
                  <div style={{
