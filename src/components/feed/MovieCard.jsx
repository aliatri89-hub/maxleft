...
const ARTWORK_THEME = {
  ...
  logoFilter: () => "brightness(0) invert(1) brightness(0.82) drop-shadow(0 2px 6px rgba(0,0,0,0.8))",
...
const FILMSTRIP_THEME = {
  ...
  logoFilter: () => "brightness(0) invert(1) brightness(0.82) sepia(0.15) drop-shadow(0 1px 3px rgba(0,0,0,0.6))",
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{
          position: "absolute", inset: 0, pointerEvents: "none",
          background: "linear-gradient(180deg, rgba(34,28,18,0.6) 0%, rgba(42,32,22,0.4) 50%, rgba(30,26,16,0.65) 100%)",
        }} />
        {/* Grain */}
        <div style={{
